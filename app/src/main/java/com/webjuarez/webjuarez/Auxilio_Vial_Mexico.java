 ...
 */
public class Auxilio_Vial_Mexico extends Activity {



    String nombre, email, cel, tel;
    String recipient, subject, body;
    ImageButton homeButton, llamarButton, emailButton, citaButton,userButton, botonChrysler,botonFiat,botonMitsubishi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auxilio_vial_mexico);
        ...
        addListenerBotonFiat();
        addListenerBotonMitsubishi();
    ...
    public void addListenerBotonMitsubishi() {

        botonMitsubishi = (ImageButton) findViewById(R.id.botonMitsubishi);

        botonMitsubishi.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View arg0) {

                ParseQuery<ParseObject> query = ParseQuery.getQuery("datos_contacto");
                query.whereEqualTo("tipo_contacto", "auxilio_vial_mitsubishi");
    ...
    public void addListenerBotonFiat() {

        botonFiat = (ImageButton) findViewById(R.id.botonFiat);

        botonFiat.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View arg0) {

                ParseQuery<ParseObject> query = ParseQuery.getQuery("datos_contacto");
                query.whereEqualTo("tipo_contacto", "auxilio_vial_fiat");
                query.findInBackground(new FindCallback<ParseObject>() {
                    public void done(List<ParseObject> scoreList, ParseException e) {
                        if (e == null) {
                            int len = scoreList.size();
    ...
    public void addListenerBotonChrysler() {
        ...
        botonChrysler.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                ParseQuery<ParseObject> query = ParseQuery.getQuery("datos_contacto");
                query.whereEqualTo("tipo_contacto", "auxilio_vial_mexico");
                query.findInBackground(new FindCallback<ParseObject>() {
                    public void done(List<ParseObject> scoreList, ParseException e) {
                        if (e == null) {
                            int len = scoreList.size();
                        ...
                        if (e == null) {
                            ...
                            for (int i = 0; i < len; i++) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(Auxilio_Vial_Mexico.this, "No dispone de aplicaciones email.",
    ...
    public void addListenerHomeButton() {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(Auxilio_Vial_Mexico.this, WelcomeNoLogin.class);

                Auxilio_Vial_Mexico.this.startActivity(myIntent);
...
// Initialize SmsManager Object// add the phone number in the data
                                ...
                                try {
                                    ...
                                    Toast.makeText(Auxilio_Vial_Mexico.this, "ERROR - SMS no enviado...",
