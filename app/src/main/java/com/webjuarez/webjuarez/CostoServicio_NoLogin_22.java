...
import static com.webjuarez.webjuarez.R.id.spinner1;

/**
 * Created by modestovascofornas on 11/15/15.
 */
public class CostoServicio_NoLogin_22 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_costo_no_login_22);
...
//FIN SPINNERS
    ...
    private void getData_anos(){
        ...
        Log.d("score", "Celular: " + ConfigKm.DATA_URL+"?id="+codigo_agencia);

        StringRequest stringRequest = new StringRequest(ConfigKm.DATA_URL+"?id="+codigo_agencia,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            result = j.getJSONArray(ConfigKm.JSON_ARRAY);
    ...
    private void getAnos(JSONArray j){
        ...
        for(int i=0;i<j.length();i++){
            try {
                ...
                anos.add(json.getString(ConfigKm.TAG_KM));
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
        ...
        spinner2.setAdapter(new ArrayAdapter<String>(CostoServicio_NoLogin_22.this, android.R.layout.simple_spinner_dropdown_item, anos));
    ...
    private void getModelos(JSONArray j){
        ...
        //Setting adapter to show the items in the spinner
        spinner.setAdapter(new ArrayAdapter<String>(CostoServicio_NoLogin_22.this, android.R.layout.simple_spinner_dropdown_item, modelos));
    ...
    public void addListenerHomeButton() {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(CostoServicio_NoLogin_22.this, WelcomeNoLogin.class);

                CostoServicio_NoLogin_22.this.startActivity(myIntent);
        ...
        userButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                try {
                    ...
                    Toast.makeText(CostoServicio_NoLogin_22.this, "No dispone de aplicaciones email.",
    ...
    public void addListenerLlamarButton() {
        ...
        llamarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                new AlertDialog.Builder(CostoServicio_NoLogin_22.this)
...
// Initialize SmsManager Object// add the phone number in the data
                ...
                try {
                    ...
                    Toast.makeText(CostoServicio_NoLogin_22.this, "ERROR - SMS no enviado...",
    ...
    public void addListenerContinuarButton() {
        ...
        continuarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(CostoServicio_NoLogin_22.this, CostoServicio_NoLogin_3.class);
