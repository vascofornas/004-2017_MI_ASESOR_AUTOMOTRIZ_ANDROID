                        ...
                        if (e == null) {
                            ...
                            for (int i = 0; i < len; i++) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(PrestigeActivity.this, "No dispone de aplicaciones email.",
    ...
    public void addListenerHomeButton() {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(PrestigeActivity.this, WelcomeNoLogin.class);

                PrestigeActivity.this.startActivity(myIntent);
...
// Initialize SmsManager Object// add the phone number in the data
                                ...
                                try {
                                    ...
                                    Toast.makeText(PrestigeActivity.this, "ERROR - SMS no enviado...",
