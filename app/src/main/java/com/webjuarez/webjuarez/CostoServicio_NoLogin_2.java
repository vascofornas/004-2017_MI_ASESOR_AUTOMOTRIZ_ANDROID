...
getData();
    ...
    private void getAnos(JSONArray j){
        ...
        spinner2.setAdapter(new ArrayAdapter<String>(CostoServicio_NoLogin_2.this, android.R.layout.simple_spinner_dropdown_item, anos));
    ...
    private void getModelos(JSONArray j){
        ...
        //Setting adapter to show the items in the spinner
        spinner.setAdapter(new ArrayAdapter<String>(CostoServicio_NoLogin_2.this, android.R.layout.simple_spinner_dropdown_item, modelos));
    ...
    public void addListenerLlamarButton() {
        ...
        llamarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                new AlertDialog.Builder(CostoServicio_NoLogin_2.this)
    ...
    public void addListenerContinuarButton() {
        ...
        continuarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(CostoServicio_NoLogin_2.this, CostoServicio_NoLogin_22.class);
