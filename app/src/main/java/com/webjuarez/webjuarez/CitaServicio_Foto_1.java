 ...
 */
public class CitaServicio_Foto_1 extends Activity {
                        ...
                        if (e == null) {
                            ...
                            for (int i = 0; i < len; i++) {
                                ...
                                try {
                                    ...
                                    Toast.makeText(CitaServicio_Foto_1.this, "No dispone de aplicaciones email.",
    ...
    public void addListenerHomeButton() {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(CitaServicio_Foto_1.this, WelcomeNoLogin.class);

                CitaServicio_Foto_1.this.startActivity(myIntent);
...
// Initialize SmsManager Object// add the phone number in the data
                                ...
                                try {
                                    ...
                                    Toast.makeText(CitaServicio_Foto_1.this, "ERROR - SMS no enviado...",
