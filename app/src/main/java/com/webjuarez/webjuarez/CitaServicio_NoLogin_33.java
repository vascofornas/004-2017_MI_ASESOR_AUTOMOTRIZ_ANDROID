 ...
 */
public class CitaServicio_NoLogin_33 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cita_no_login_33);
...
getData();
    ...
    private void getAnos(JSONArray j){
        ...
        spinner2.setAdapter(new ArrayAdapter<String>(CitaServicio_NoLogin_33.this, android.R.layout.simple_spinner_dropdown_item, anos));
    ...
    private void getModelos(JSONArray j){
        ...
        //Setting adapter to show the items in the spinner
        spinner.setAdapter(new ArrayAdapter<String>(CitaServicio_NoLogin_33.this, android.R.layout.simple_spinner_dropdown_item, modelos));
    ...
    public void addListenerHomeButton() {
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(CitaServicio_NoLogin_33.this, WelcomeNoLogin.class);

                CitaServicio_NoLogin_33.this.startActivity(myIntent);
        ...
        userButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                try {
                    ...
                    Toast.makeText(CitaServicio_NoLogin_33.this, "No dispone de aplicaciones email.",
    ...
    public void addListenerLlamarButton() {
        ...
        llamarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                new AlertDialog.Builder(CitaServicio_NoLogin_33.this)
...
// Initialize SmsManager Object// add the phone number in the data
                ...
                try {
                    ...
                    Toast.makeText(CitaServicio_NoLogin_33.this, "ERROR - SMS no enviado...",
    ...
    public void addListenerContinuarButton() {
        ...
        continuarButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(CitaServicio_NoLogin_33.this, CitaServicio_NoLogin_4.class);
